    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            <div class="small text-muted mb-1">
                <a href="{{ route('admin.departments.index') }}" class="text-decoration-none" style="color:#E65C00;">
            ...
            <h5 class="fw-bold mb-0" style="color:#1B2A4A;">
                <div class="d-inline-flex align-items-center justify-content-center rounded-circle me-2"
                     style="width:36px;height:36px;background:{{ $department->is_active ? '#E65C00' : '#94A3B8' }};color:#fff;font-size:14px;font-weight:700;vertical-align:middle;">
                    {{ strtoupper(substr($department->name, 0, 2)) }}
                </div>
                {{ $department->name }}
                <span class="badge ms-2 align-middle px-2 py-1"
                      style="font-size:11px;border-radius:20px;background:{{ $department->is_active ? '#D1FAE5' : '#FEE2E2' }};color:{{ $department->is_active ? '#065F46' : '#991B1B' }};">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.departments.account-codes', $department) }}"
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3 col-6">
            <div class="stat-card text-center">
                ...
                <div class="stat-value" style="font-size:20px;">
                    <code style="color:#1B2A4A;">{{ $department->code }}</code>
                </div>
                <div class="stat-sub">Department code</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="stat-card text-center">
                ...
                <div class="stat-value" style="color:#6366F1;">{{ $department->users->count() }}</div>
        ...
        <div class="col-md-3 col-6">
            <div class="stat-card text-center">
                ...
                <div class="stat-value" style="color:#F59E0B;">{{ $department->accountCodes->count() }}</div>
