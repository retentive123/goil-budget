...
<head>
    ...
    <title>Too Many Requests — GOIL Budget</title>
    <style>
...
<div class="card">
    <div class="card-header">
        <div class="icon">✋</div>
        <h3>Slow Down</h3>
        <p>Too many requests in a short period</p>
    </div>

    <div class="card-body">
        <div class="error-code">429</div>

        <div class="main-msg">You've made too many requests</div>
        ...
        <div class="tips">
            <div class="tips-title">💡 What now?</div>
            <ul>
                <li>Wait 60 seconds and try again</li>
                <li>Avoid clicking buttons repeatedly</li>
